<!-- ARCHIVED 2026-05-18. This is the pre-orchestrator-framing version of the build plan, preserved for audit/history. The current plan is MASTERMIND_BUILD_PLAN.md (orchestrator framing, approved 2026-05-18). See that file for the live phasing, tool catalog, and Phase 2/3 spec. -->
