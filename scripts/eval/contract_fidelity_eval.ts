...
// ─────────────────────────────────────────────────────────────────────────────
// Mechanical adjudication lives in ./fpAdjudication.ts so the CI-5 gate
// harness can reuse it without importing this script (which runs main()).
import {
  adjudicateFp,
  buildFpPools,
  EVAL_ADJUDICATION_TOLERANCE,
} from "./fpAdjudication";
import type {
  FpAdjudicateHelpers,
  FpAdjudication,
