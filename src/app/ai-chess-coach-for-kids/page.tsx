...
export const metadata: Metadata = {
  title: { absolute: "AI Chess Coach for Kids | Free, Plain-Language Game Reviews" },
  description:
  ...
  twitter: {
    ...
    title: "AI Chess Coach for Kids | Chess Masti AI",
    description: "Clear, kid-friendly game reviews. No jargon, no in-app purchases. Free.",
...
export default function AiChessCoachForKidsPage() {
  const schemas = [
    buildWebPageJsonLd({
      ...
      url: URL,
      description: "Free AI chess coach tuned for kid-friendly explanations and parent-friendly access.",
    }),
  ...
  return (
    <PageShell>
      ...
      <Box component="section" sx={{ mb: 10 }}>
        ...
        <ProseBlock>
          The chat is powered by an LLM (Claude AI). It produces text responses. The system prompt
          is tuned for clarity and patience, but kids may still encounter the occasional dry or
          technical answer. If you want to vet the tone before handing it to a younger child, run a
          few of their games through first.
        </ProseBlock>
        <ProseBlock>
          Account features (saved games, personalization) require sign-in. For kids under 13, COPPA
          and similar regulations apply — handle the account from a parent address rather than
          giving a child unsupervised account creation. The analysis board itself works without an
          account, so you don&apos;t need to register to get coaching.
        </ProseBlock>
        <ProseBlock>
          Chess Masti is not a chess-teaching curriculum for absolute beginners — it&apos;s a
          coach for kids who already play. If your child has never played a full game yet, start
          with a learn-to-play resource and come back here once they have a few games to review.
        </ProseBlock>
      </Box>
      ...
      <Box component="section" sx={{ mb: 10 }}>
        ...
        <ProseBlock>
          2. Paste it in. Sit next to them. Click through the moves together. Stop at the biggest
          eval swings — those are where the lesson is.
        </ProseBlock>
        <ProseBlock>
          3. Read the explanation together. Ask the chat a follow-up question if they don&apos;t
          understand: &quot;why was that bad?&quot; or &quot;what could I have done instead?&quot;
        </ProseBlock>
        <ProseBlock>
          4. Convert the worst mistake into a puzzle. Drill it five times. One lesson per game is
          plenty.
        </ProseBlock>
      </Box>
      ...
      <FooterCta title="Coach your kid's chess games" sub="Paste a PGN. Sit together. Read the lesson." />
    </PageShell>
  );
}
