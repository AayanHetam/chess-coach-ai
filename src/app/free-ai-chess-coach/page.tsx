...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://chessmasti.com/free-ai-chess-coach",
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Free AI Chess Coach",
        item: "https://chessmasti.com/free-ai-chess-coach",
      },
    ],
  };
...
export default function FreeAiChessCoachPage() {
  const schemas = pageJsonLd();

  return (
    <Box sx={{ background: BG, minHeight: "100vh", color: "rgba(255,255,255,0.85)" }}>
      {/* JSON-LD */}
      ...
      <Box sx={{ maxWidth: 800, mx: "auto", px: { xs: 2, md: 4 }, py: { xs: 6, md: 10 } }}>
        ...
        >
          ...
          <span>/</span>
          <span style={{ color: "rgba(255,255,255,0.7)" }}>Free AI Chess Coach</span>
        </Box>
        ...
        <Box sx={{ display: "flex", gap: 2, flexWrap: "wrap", mb: 10 }}>
          ...
          <CtaButton href="/practice">
            Train your mistakes
          </CtaButton>
          <CtaButton href="/scout">
            Scout an opponent
          </CtaButton>
        </Box>
            ...
            >
              ...
              <tbody>
                <tr>
                  ...
                  <td style={{ color: EMBER }}>✓ Fully free</td>
                  <td>Claude AI</td>
