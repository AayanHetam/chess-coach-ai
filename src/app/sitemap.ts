...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes: {
    ...
    { path: "/lichess-opponent-scout", changeFrequency: "monthly", priority: 0.85 },
    { path: "/mistake-based-chess-puzzles", changeFrequency: "monthly", priority: 0.85 },
    ...
    { path: "/free-chess-coach-for-beginners", changeFrequency: "monthly", priority: 0.8 },
    { path: "/ai-chess-coach-for-kids", changeFrequency: "monthly", priority: 0.8 },
    { path: "/ai-chess-coach-for-india", changeFrequency: "monthly", priority: 0.8 },
    { path: "/train-chess-mistakes-with-ai", changeFrequency: "monthly", priority: 0.8 },
