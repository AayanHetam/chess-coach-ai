...
export const openingPrinciples: ChessPrinciple[] = [
  {
    ...
    description:
      "Occupy or influence e4, d4, e5, or d5 to gain space and flexibility for piece play",
    category: "opening",
    priority: 9,
  },
  {
    ...
    description:
      "Move knights to f3/c3 (or f6/c6 for Black) and bishops to active squares like c4 or f4",
    category: "opening",
    priority: 8,
  },
  {
    ...
    description:
      "Develop all minor pieces and castle before launching premature attacks",
    category: "opening",
    priority: 8,
  },
  {
    ...
    description:
      "Unless tactically justified, develop all pieces to avoid wasting time",
    category: "opening",
    priority: 7,
  },
  {
    ...
    name: "Castle early",
    description:
      "Safeguard your king and connect rooks for better coordination",
    category: "opening",
    priority: 8,
  },
  {
  ...
  },
  {
    ...
    description:
      "Focus on piece development rather than pushing too many pawns",
    category: "opening",
    priority: 6,
  },
  {
    ...
    name: "Connect rooks",
    description:
      "Ensure rooks can support each other, often by castling or clearing the back rank",
    category: "opening",
    priority: 6,
  },
  {
    ...
    description:
      "Keep central pawns and pieces free to move, e.g., don't block the c-pawn with a knight on c3 in some openings",
    category: "opening",
    priority: 6,
  },
  {
    ...
    description:
      "Choose openings that align with your preferred style (open or closed positions)",
    category: "opening",
    priority: 5,
  },
  {
    ...
    description:
      "Avoid early commitments that limit your options, like overextending pawns",
    category: "opening",
    priority: 5,
  },
  // NEW PRINCIPLES ADDED
  {
    ...
    description:
      "Position pieces to influence central squares, increasing their scope",
    category: "opening",
    priority: 7,
  },
  {
    ...
    description:
      "Ensure sufficient development before launching aggressive moves",
    category: "opening",
    priority: 7,
  },
  {
  ...
  },
  {
    ...
    description:
      "Refrain from moving pawns in front of your king unless necessary",
    category: "opening",
    priority: 8,
  },
  {
    ...
    description:
      "Set up potential pawn advances (e.g., c4 or f4) to open lines later",
    category: "opening",
    priority: 5,
  },
  {
  ...
  },
  {
    ...
    description:
      "Be cautious of moves that allow pins, like placing a knight on f3 before castling",
    category: "opening",
    priority: 7,
  },
  {
...
export const middlegamePrinciples: ChessPrinciple[] = [
  {
    ...
    description:
      "Place pieces on squares where they control the most squares or attack weaknesses",
    category: "middlegame",
    priority: 9,
  },
  {
    ...
    description:
      "Identify and activate your least active piece to improve overall coordination",
    category: "middlegame",
    priority: 8,
  },
  {
    ...
    description:
      "Knights and bishops are often strongest in the center (e.g., d4, e5)",
    category: "middlegame",
    priority: 8,
  },
  {
    ...
    description:
      "Ensure pieces work together, e.g., a bishop and queen targeting the same diagonal",
    category: "middlegame",
    priority: 8,
  },
  {
    ...
    description:
      "Consider and prevent your opponent's plans before executing your own",
    category: "middlegame",
    priority: 7,
  },
  {
    ...
    description:
      "Position knights on squares (like e5 or d5) where they can't be easily dislodged by pawns",
    category: "middlegame",
    priority: 7,
  },
  {
    ...
    description:
      "Position bishops to control long, open diagonals for maximum influence",
    category: "middlegame",
    priority: 7,
  },
  {
    ...
    description:
      "Place rooks on open or semi-open files to penetrate the opponent's position",
    category: "middlegame",
    priority: 8,
  },
  {
    ...
    description:
      "Target isolated, doubled, or backward pawns to create weaknesses",
    category: "middlegame",
    priority: 7,
  },
  {
    ...
    description:
      "Advance pawns to create passed pawns, especially in positions transitioning to the endgame",
    category: "middlegame",
    priority: 6,
  },
  {
    ...
    description:
      "Keep your king behind a solid pawn structure, avoiding weaknesses like open lines to the king",
    category: "middlegame",
    priority: 9,
  },
  {
    ...
    description:
      "Make moves that force your opponent to respond, keeping them on the defensive",
    category: "middlegame",
    priority: 7,
  },
  {
    ...
    description:
      "Use pawn advances (e.g., f4-f5 or c4-c5) to open lines or disrupt the opponent's structure",
    category: "middlegame",
    priority: 6,
  },
  {
    ...
    description:
      "Dominate central or strategic squares (like d5 or e4) to limit opponent options",
    category: "middlegame",
    priority: 8,
  },
  // NEW PRINCIPLES ADDED
  {
    ...
    description:
      "Calculate for forks, pins, skewers, and discovered attacks to avoid blunders",
    category: "middlegame",
    priority: 9,
  },
  {
  ...
  },
  {
    ...
    description:
      "Limit the opponent's pieces by controlling key squares or creating pawn barriers",
    category: "middlegame",
    priority: 7,
  },
  {
    ...
    description:
      "The two bishops together are often stronger than two knights or a knight and bishop",
    category: "middlegame",
    priority: 6,
  },
  {
  ...
  },
  {
    ...
    description:
      "Protect critical squares or pieces more than necessary to gain flexibility",
    category: "middlegame",
    priority: 6,
  },
  {
    ...
    description:
      "Use extra space to maneuver pieces and cramp the opponent's position",
    category: "middlegame",
    priority: 7,
  },
  {
    ...
    description:
      "Create threats against the king, especially if it's exposed or uncastled",
    category: "middlegame",
    priority: 8,
  },
  {
    ...
    description:
      "Stack rooks to increase pressure and penetrate the opponent's position",
    category: "middlegame",
    priority: 7,
  },
  {
    ...
    description:
      "Position the queen to support attacks without exposing it to traps",
    category: "middlegame",
    priority: 7,
  },
  {
    ...
    description:
      "Use pins to immobilize opponent pieces and create tactical opportunities",
    category: "middlegame",
    priority: 7,
  },
  {
    ...
    description:
      "Force the opponent to overextend or create isolated/doubled pawns",
    category: "middlegame",
    priority: 6,
  },
  {
    ...
    description:
      "Reposition pieces to better squares, even if it takes an extra move",
    category: "middlegame",
    priority: 7,
  },
  {
    ...
    description:
      "Target squares of one color if the opponent lacks a bishop to defend them",
    category: "middlegame",
    priority: 6,
  },
  {
  ...
  },
  {
    ...
    description:
      "Use rooks or queens to back up knights and bishops in attacks",
    category: "middlegame",
    priority: 6,
  },
  {
    ...
    description:
      "Trade pieces to simplify when ahead or to disrupt opponent coordination",
    category: "middlegame",
    priority: 6,
  },
];
...
export const endgamePrinciples: ChessPrinciple[] = [
  ...
  },
  {
    ...
    description:
      "Place pieces (especially knights) to stop enemy pawns from advancing",
    category: "endgame",
    priority: 7,
  },
  {
    ...
    description:
      "Trade pieces to reduce complexity and convert material advantages",
    category: "endgame",
    priority: 7,
  },
  {
    ...
    description:
      "In pawn endgames, control key squares to outmaneuver the opponent's king",
    category: "endgame",
    priority: 6,
  },
  {
    ...
    description:
      "Maneuver your king to force the opponent into a worse position",
    category: "endgame",
    priority: 5,
  },
  {
    ...
    name: "Force zugzwang",
    description:
      "Create positions where any opponent move worsens their situation",
    category: "endgame",
    priority: 6,
  },
  {
    ...
    description:
      "Advance pawn majorities (e.g., 3 vs. 2 on one side) to create passed pawns",
    category: "endgame",
    priority: 7,
  },
  // NEW PRINCIPLES ADDED
  {
    ...
    description:
      "Understand techniques like the Lucena or Philidor positions in rook endgames",
    category: "endgame",
    priority: 7,
  },
  {
  ...
  },
  {
    ...
    description:
      "In defensive positions, create structures that are hard to break",
    category: "endgame",
    priority: 6,
  },
  {
    ...
    description:
      "Use pieces to restrict the opponent's king from entering the game",
    category: "endgame",
    priority: 7,
  },
  {
    ...
    description:
      "Place rooks behind your passed pawns to support their advance",
    category: "endgame",
    priority: 7,
  },
  {
    ...
    description:
      "Keep rooks active, avoiding placement in front of your own pawns",
    category: "endgame",
    priority: 6,
  },
  {
    ...
    description:
      "Understand techniques like checking from the side or cutting off the king",
    category: "endgame",
    priority: 7,
  },
  {
  ...
  },
  {
    ...
    description:
      "Keep pawns on the board to create counterplay in losing positions",
    category: "endgame",
    priority: 6,
  },
  {
    ...
    description:
      "Trade to simplify when ahead, but retain pieces for attack when behind",
    category: "endgame",
    priority: 6,
  },
  {
...
export const generalPrinciples: ChessPrinciple[] = [
  {
    ...
    description:
      "Always check that your pieces are defended before moving, scan for undefended pieces",
    category: "general",
    priority: 10,
  },
  {
    ...
    description:
      "Scan for tactical motifs like forks, pins, skewers, and discovered attacks",
    category: "general",
    priority: 9,
  },
  {
    ...
    description:
      "Only sacrifice material for clear positional or tactical gains",
    category: "general",
    priority: 9,
  },
  {
    ...
    description:
      "Use approximate values (pawn=1, knight=3, bishop=3, rook=5, queen=9) to assess trades",
    category: "general",
    priority: 8,
  },
  {
    ...
    name: "Control space",
    description:
      "Dominate central and key squares to give your pieces more room and limit the opponent's",
    category: "general",
    priority: 8,
  },
  {
    ...
    description:
      "Generate threats to offset the opponent's advantages, especially in worse positions",
    category: "general",
    priority: 6,
  },
  {
    ...
    description:
      "Avoid weaknesses like isolated or doubled pawns, and exploit them in the opponent's position",
    category: "general",
    priority: 7,
  },
  {
    ...
    description:
      "Ensure moves are tactically sound by checking for checks, captures, and threats",
    category: "general",
    priority: 9,
  },
  // NEW PRINCIPLES ADDED
  {
    ...
    description:
      "Consider specific trade-offs, like two minor pieces vs. a rook",
    category: "general",
    priority: 7,
  },
  {
    ...
    description:
      "Sacrifice material for long-term advantages, like opening lines or gaining the initiative",
    category: "general",
    priority: 7,
  },
  {
    ...
    description:
      "Evaluate how open or vulnerable each king is, even in the middlegame",
    category: "general",
    priority: 8,
  },
  {
    ...
    description:
      "Don't push pawns or pieces too far without sufficient support",
    category: "general",
    priority: 7,
  },
  {
  ...
  },
  {
    ...
    name: "Evaluate tempo",
    description:
      "Make moves that gain time or force the opponent to lose tempo",
    category: "general",
    priority: 7,
  },
  {
    ...
    description:
      "Play dynamically in open positions and patiently in closed ones",
    category: "general",
    priority: 6,
  },
  {
  ...
  },
  {
    ...
    description:
      "Anticipate how the game might shift from opening to middlegame or middlegame to endgame",
    category: "general",
    priority: 6,
  },
  {
  ...
  },
  {
    ...
    description:
      "Place rooks on the opponent's second rank to attack pawns or trap the king",
    category: "general",
    priority: 7,
  },
  {
  ...
  },
  {
    ...
    description:
      "Favor moves that increase your pieces' scope and restrict the opponent's",
    category: "general",
    priority: 7,
  },
  {
    ...
    description:
      "Position pieces to uncover threats, especially with bishops or queens",
    category: "general",
    priority: 7,
  },
  {
    ...
    description:
      "In safe positions, consider subtle king moves to improve position",
    category: "general",
    priority: 5,
  },
  {
  ...
  },
  {
    ...
    description:
      "Ensure attacks target specific weaknesses or create lasting advantages",
    category: "general",
    priority: 7,
  },
  {
  ...
  },
  {
    ...
    description:
      "Choose moves that suit the position's nature (e.g., bishops in open games)",
    category: "general",
    priority: 6,
  },
  {
    ...
    description:
      "Look for tactical sacrifices that open lines or expose the opponent's king",
    category: "general",
    priority: 7,
  },
];
