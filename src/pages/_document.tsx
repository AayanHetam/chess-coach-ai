  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta property="og:title" content="Chess Masti AI - Make Chess Fun with AI!" />
        <meta property="og:description" content="Make chess fun with AI-powered coaching! Learn through engaging principles and enjoy the masti (fun) of improving your game." />
        ...
        <meta name="twitter:description" content="Make chess fun with AI-powered coaching! Learn through engaging principles and enjoy the masti of improving your game." />
