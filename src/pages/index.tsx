...
function TopBar() {
  return (
    ...
    >
      ...
      <PrimaryCTA href="/analysis">Start coaching</PrimaryCTA>
    </Box>
  );
}
        ...
        >
          ...
          <Box
            sx={{
              ...
              mx: { xs: "auto", md: 0 },
              boxShadow:
                "0 0 40px rgba(249,115,22,0.4), inset 0 -12px 24px rgba(0,0,0,0.2)",
            }}
          >
            A
          </Box>
          ...
          <Box sx={{ position: "relative", zIndex: 1 }}>
            ...
            >
              "I grew up in urban-poor Mumbai. A{" "}
              <Box
                component="span"
                sx={{
                  background:
...
function StatsStrip() {
  const stats = [
    { value: 3500, prefix: "", suffix: "+", label: "Engine Elo behind every verdict" },
  ...
  return (
    ...
    >
      ...
      <Box sx={{ position: "relative" }}>
        ...
        >
          Get top-tier analysis without the $100/hour bill. No sign-up.
