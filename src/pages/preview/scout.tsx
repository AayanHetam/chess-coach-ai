...
/**
 * /preview/scout — server-side 308 redirect to /scout after the preview
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
  ...
  const destination = queryString ? "/scout?" + queryString : "/scout";
  return {
    redirect: {
      destination,
      permanent: true,
...
export default function PreviewScoutRedirect() {
  return null;
}
