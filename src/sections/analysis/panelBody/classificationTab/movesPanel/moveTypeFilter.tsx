...
const MOVE_TYPE_INFO: Record<
  MoveClassification,
  { label: string; description: string }
> = {
  [MoveClassification.Brilliant]: {
    label: "Brilliant",
    description: "Excellent piece sacrifice",
  },
  [MoveClassification.Great]: {
    label: "Great",
    description: "Critical move for game outcome",
  },
  [MoveClassification.Best]: {
    label: "Best",
    description: "Engine's top choice",
  },
  ...
  [MoveClassification.Opening]: {
    label: "Opening",
    description: "Book opening move",
  },
  [MoveClassification.Inaccuracy]: {
    label: "Inaccuracy",
    description: "Slight mistake",
  },
...
export default function MoveTypeFilter({ onFilterChange }: Props) {
  const [selectedTypes, setSelectedTypes] =
    useState<MoveClassification[]>(FILTER_ORDER);
      ...
      >
        ...
        <Stack direction="row" spacing={0.3}>
          <Chip
            ...
            size="small"
            variant={
              selectedTypes.length === FILTER_ORDER.length
                ? "filled"
                : "outlined"
            }
