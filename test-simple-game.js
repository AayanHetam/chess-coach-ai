...
/**
 * Simple test for Full Game Analysis
 * Tests that the AI has access to complete game data with a simple game
 */

async function testSimpleGame() {
  console.log('🎯 Testing Simple Game Analysis - No More Hallucination\n');
  console.log('=' .repeat(60));
  
  // Test data with a simple game that has obvious principle violations
  const testData = {
    moveHistory: ["e4", "e5", "Nf3", "Nc6", "Bc4", "Bc5", "d3", "d6", "O-O", "Nf6", "Nc3", "O-O"],
  ...
  try {
    ...
    console.log('\n🎯 Simple Game Analysis Test Results:');
...
testSimpleGame().catch(console.error); 